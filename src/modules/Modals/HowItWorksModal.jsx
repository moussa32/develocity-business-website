                  ...
                  <form className="px-5 mt-16">
                    ...
                    <div className="mx-auto grid grid-cols-1">
                      <div className="mx-auto mt-7 md:w-[695px]">
                        ...
                        <textarea
                          className="border text-base text-neutral-700 border-neutral-300 outline-none transition-all ease-in-out duration-300 rounded p-4 focus:border-indigo-500 md:h-44 w-[270px] md:w-[695px]"
                          name="about-project"
                        />
                      </div>
