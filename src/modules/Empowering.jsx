...
const Empowering = ({ onOpenModal }) => {
  return (
    <div id="home" className="relative text-center flex items-center overflow-hidden w-full md:text-left h-screen">
      <video playsInline className="absolute h-full w-full z-0 object-cover" height="100%" muted autoPlay>
