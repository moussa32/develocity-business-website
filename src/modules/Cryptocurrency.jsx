  ...
  return (
    <div className='container mx-auto text-center md:text-left mt-20 md:mt-36 md:mb-48'>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div>
          <span className='uppercase text-xs text-indigo-500 font-semibold mb-2'>Cryptocurrency Creation</span>
          <h4 className='text-3xl md:text-4xl font-normal mb-6'>Cryptocurrency Development and Initial Coin Offering (ICO).</h4>
